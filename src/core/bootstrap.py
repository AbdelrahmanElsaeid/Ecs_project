...
from src.core.models import Submission, MedicalCategory, EthicsCommission, AdvancedSettings
from src.checklists.models import ChecklistBlueprint
from src.utils import Args
from src.workflow.patterns import Generic
from src.integration.utils import setup_workflow_graph
from src.users.utils import get_or_create_user, get_user
...
@bootstrap.register(depends_on=(
    'src.core.bootstrap.auth_groups',
    'src.core.bootstrap.medical_categories',
    'src.checklists.bootstrap.checklist_workflow',
    'src.core.bootstrap.submission_workflow',
    'src.notifications.bootstrap.notification_workflow',
    'src.votes.bootstrap.vote_workflow',
))
...
def ethics_commissions():
    ...
    from core.bootstrap_settings import commissions
...
@bootstrap.register(depends_on=('src.core.bootstrap.auth_user_testusers',))
