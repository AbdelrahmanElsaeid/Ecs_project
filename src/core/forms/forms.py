...
from src.core.models.core import (
    AdvancedSettings, EthicsCommission,
)
from src.core.models import (
    Investigator, InvestigatorEmployee, SubmissionForm, Measure,
    ParticipatingCenterNonSubject, ForeignParticipatingCenter,
    NonTestedUsedDrug, Submission, TemporaryAuthorization,
)

from src.utils.formutils import require_fields
from src.core.forms.fields import StrippedTextInput, NullBooleanField, \
    EmailUserSelectWidget, AutocompleteModelChoiceField, DateTimeField
from src.core.forms.utils import ReadonlyFormMixin, ReadonlyFormSetMixin
from src.users.utils import get_current_user
from src.tags.forms import TagMultipleChoiceField
...
class AdvancedSettingsForm(forms.ModelForm):
    ...
    default_contact= forms.ModelChoiceField(queryset=User.objects.filter(
            Q(profile__is_internal=True)
        ))
