...
#     f"{date_format} {time_format}" for time_format in TIME_INPUT_FORMATS for date_format in DATE_INPUT_FORMATS
# ]
...
#         kwargs.setdefault("input_formats", DATE_INPUT_FORMATS)
#         kwargs.setdefault(
#             "error_messages", {"invalid": _("Please enter a date in the format dd.mm.yyyy.")}
#         )
#         super().__init__(*args, **kwargs)
...
#         kwargs.setdefault("input_formats", DATE_TIME_INPUT_FORMATS)
#         kwargs.setdefault(
#             "widget", forms.SplitDateTimeWidget(date_format=DATE_INPUT_FORMATS[0])
#         )
#         kwargs.setdefault(
#             "error_messages",
#             {
#                 "invalid": _(
#                     "Please enter a date in dd.mm.yyyy format and time in format HH:MM."
#                 )
#             },
#         )
#         super().__init__(*args, **kwargs)
...
#         kwargs.setdefault(
#             "error_messages",
#             {"invalid": _("Please enter a time in the format HH: MM.")},
#         )
#         kwargs.setdefault("widget", LooseTimeWidget())
#         super().__init__(*args, **kwargs)
...
#         attrs["data-ajax--url"] = reverse(
#             "core:autocomplete",
#             #'src.core.views.autocomplete.autocomplete',
#             kwargs={"queryset_name": self.field.queryset_name},
#         )
#         return super().render(name, value, attrs=attrs)
...
#             force_str(v) for v in selected_choices if v != ""
#         )
#         output = []
#         objs = self.field.queryset.filter(pk__in=selected_choices)
#         for obj in objs:
...
# class AutocompleteModelChoiceField(
#     AutocompleteFieldMixin, forms.ModelChoiceField
# ):
#     class widget(AutocompleteWidgetMixin, forms.Select):
#         pass


# class AutocompleteModelMultipleChoiceField(
#     AutocompleteFieldMixin, forms.ModelMultipleChoiceField
# ):
#     class widget(AutocompleteWidgetMixin, forms.SelectMultiple):
#         pass
