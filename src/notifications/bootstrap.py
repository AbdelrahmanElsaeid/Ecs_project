...
from src.notifications.models import NotificationType, Notification
from src.workflow.patterns import Generic
from src.integration.utils import setup_workflow_graph
from src.utils import Args
from src.notifications.workflow import (
...
def notification_types():
    types = (
        dict(
            ...
            form = "notifications.forms.SafetyNotificationForm",
        ...
        dict(
            ...
            form = "notifications.forms.ProgressReportNotificationForm",
            default_response = "",
            includes_diff = False,
        ...
        dict(
            ...
            form = "notifications.forms.CompletionReportNotificationForm",
            default_response = "",
            includes_diff = False,
            grants_vote_extension = False,
            is_rejectable = True,
        ...
        dict(
            name = "Amendment",
            form = "notifications.forms.AmendmentNotificationForm",
        ...
        dict(
            ...
            form = "notifications.forms.CenterCloseNotificationForm",
            default_response = "Die Kommission nimmt diese Meldung ohne Einspruch zur Kenntnis.",
            includes_diff = False,
            grants_vote_extension = False,
            is_rejectable = True,
...
@bootstrap.register(depends_on=('integration.bootstrap.workflow_sync', 'core.bootstrap.auth_groups'))
