...
from src.workflow.signals import token_received
from src.workflow.exceptions import TokenRequired, TokenRejected
from src.workflow.controllers.registry import add_controller
...
class NodeControllerOptions(object):
    ...
    @cached_property
    def node_type(self):
        from src.workflow.models import NodeType
        if self.model:
