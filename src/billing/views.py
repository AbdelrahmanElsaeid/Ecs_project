...
from src.users.utils import user_group_required, sudo
...
from src.billing.models import Price, ChecklistBillingState, Invoice, ChecklistPayment
...
def external_review_payment(request):
    ...
    if request.method == 'POST':
        ...
        xls = SimpleXLS()
        xls.write_row(0, (_('amt.'), _('reviewer'), _('EC-Nr.'), _('sum'), _('IBAN'), _('SWIFT-BIC')), header=True)
