...
# from src.authorization.base import QFactory,register
# from src.core.models import (Submission, SubmissionForm,
...
# from src.notifications.models import Notification, AmendmentNotification, SafetyNotification, NotificationAnswer, NOTIFICATION_MODELS
# from src.meetings.models import Meeting
# from src.votes.constants import NEGATIVE_VOTE_RESULTS


# class SubmissionQFactory(QFactory):
#     def get_q(self, user):
...
# register(Submission, factory=SubmissionQFactory)
# register(SubmissionForm, lookup='submission')

# class VoteQFactory(QFactory):
#     def get_q(self, user):
#         q = self.make_q(
...
# register(Vote, factory=VoteQFactory)

# class TaskQFactory(QFactory):
#     def get_q(self, user):
...
# register(Task, factory=TaskQFactory)

# class NotificationQFactory(QFactory):
#     def get_q(self, user):
#         return self.make_q(
...
#     register(cls, factory=NotificationQFactory)

# class NotificationAnswerQFactory(QFactory):
#     def get_q(self, user):
...
# register(NotificationAnswer, factory=NotificationAnswerQFactory)

# class ChecklistQFactory(QFactory):
#     def get_q(self, user):
...
# register(Checklist, factory=ChecklistQFactory)


# class MeetingQFactory(QFactory):
#     def get_q(self, user):
...
# register(Meeting, factory=MeetingQFactory)
